    ...
    WL.injectElements(`
        ...
        <toolbox id="mail-toolbox">
            <toolbar
                ...
                ondragover="window.QuickFolders.toolbarDragObserver.dragOver(event)"
                ondrop="window.QuickFolders.toolbarDragObserver.drop(event)"
                ondragenter="window.QuickFolders.toolbarDragObserver.dragEnter(event)"
